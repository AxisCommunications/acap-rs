...
export CFLAGS_thumbv7neon_unknown_linux_gnueabihf="-mfpu=neon"
export CXX_thumbv7neon_unknown_linux_gnueabihf="arm-linux-gnueabihf-g++"
export CXXFLAGS_thumbv7neon_unknown_linux_gnueabihf="-mfpu=neon"
...
export CARGO_TARGET_ARMV7_UNKNOWN_LINUX_GNUEABIHF_RUSTFLAGS="-C link-args=--sysroot=${SYSROOT_ARMV7HF}"
export CC_armv7_unknown_linux_gnueabihf="arm-linux-gnueabihf-gcc"
export CXX_armv7_unknown_linux_gnueabihf="arm-linux-gnueabihf-g++"
export PKG_CONFIG_LIBDIR_armv7_unknown_linux_gnueabihf="${SYSROOT_ARMV7HF}/usr/lib/pkgconfig:${SYSROOT_ARMV7HF}/usr/share/pkgconfig"
export PKG_CONFIG_PATH_armv7_unknown_linux_gnueabihf="${SYSROOT_ARMV7HF}/usr/lib/pkgconfig:${SYSROOT_ARMV7HF}/usr/share/pkgconfig"
export PKG_CONFIG_SYSROOT_DIR_armv7_unknown_linux_gnueabihf="${SYSROOT_ARMV7HF}"
