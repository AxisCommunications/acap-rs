...
| Name                           | Methods | Status |
|--------------------------------|---------|--------|
| Application                    | x/x     | Stable |
| Basic device information       | 4/4     | Stable |
| Event streaming over WebSocket | 1/1     | Stable |
| Parameter management           | 5/5     | Stable |
| Systemready                    | 2/2     | Stable |
